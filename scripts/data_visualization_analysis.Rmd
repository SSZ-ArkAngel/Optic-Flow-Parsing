...
Same.Opposite %>%
  ...
  # Add axis labels
  xlab("Gain (opposite hemifields)") +    
  ylab("Gain (same hemifield)") +
  
  # Add title
  ggtitle("Accuracy of Report based on Optic flow/Probe Location") +
...
top.bottom %>%
  ...
  # Add axis labels
  xlab("Gain (probe bottom, optic flow full)") +    
  ylab("Gain (probe top, optic flow full)") +
...
Opposite %>%
  ...
  # Add axis labels
  xlab("Gain (probe bottom, optic flow top)") +    
  ylab("Gain (probe top, optic flow bottom)") +
  
  # Add title
  ggtitle("Accuracy of Report for Opposite Flow/probe Locations") +
...
Local %>%
  ...
  # Add title
  ggtitle("Strength Local Mechanisms in Vertical Hemifields") +
...
Global %>%
  ...
  # Add axis labels
  xlab("Gain global bottom") +
  ylab("Gain global top") +

  # Add title
  ggtitle("Strength of Global Mechanisms in Vertical Hemifields") +
...
Control %>%
  ...
  # Add axis labels
  xlab("Gain (probe bottom, no optic flow)") +    
  ylab("Gain (probe top, no optic flow)") +
...
## Prediction plots (N=1) - raw data + 4 gains
```{r}
data %>%
  ...
  scale_color_manual(
    name = "Raw data & Gain",
    breaks = c("data", "best fitting gain", "gain = 0", "gain = 1", "gain = 0.6"),
    values = c("grey50", "red", "skyblue2", "green2", "orange1"),
    drop = TRUE
  ) +
