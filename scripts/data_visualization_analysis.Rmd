...
top.bottom %>%
  ...
  # Add title
  ggtitle("Relative Strength of Local Mechanisms in Vertical Hemifields") +
...
Local %>%
  ...
  # Add title
  ggtitle("Strength of Local Mechanisms in Vertical Hemifields") +
...
Control %>%
  ...
  # Add title
  ggtitle("Accuracy of Report with No Optic Flow") +
